...
public class ScreenPaperDollConfig extends Screen {
    ...
    protected void init() {
        ...
        addDrawableChild(new ModDoubleSlider(x + gridWidth, y + gridHeight * 3, btnWidth, btnHeight, Text.literal("Vertical Camera Rotation"), config.cameraRotationVDeg, -45.0, 45.0, mappedValue -> config.cameraRotationVDeg = mappedValue));
        ...
        addDrawableChild(new ModDoubleSlider(x, y + gridHeight * 5, btnWidth, btnHeight, Text.literal("Meow"), 0.5, 0, 1, mappedValue -> {}));
